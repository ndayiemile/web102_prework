...
const numberOfUnfundedGames = GAMES_JSON.filter(
  (game) => game.pledged < game.goal
).length;
const nbrOfAllGames = GAMES_JSON.length;
const haveManyUnfunded = numberOfUnfundedGames > 1;
// create a string that explains the number of unfunded games using the ternary operator
const description = `A total of $${totalRaisedAmount.toLocaleString(
  "en-US"
)} has been raised for ${nbrOfAllGames} game${
  nbrOfAllGames > 1 ? "s" : ""
}. Currently, ${numberOfUnfundedGames} game${
  haveManyUnfunded ? "s" : ""
} remain${haveManyUnfunded ? "s" : ""} unfunded. We need your help to fund ${
  haveManyUnfunded ? "these" : "this"
} amazing game${haveManyUnfunded ? "s" : ""}!`;
